            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-9 p-8 md:p-12 bg-paper border border-mist/20 rounded-md shadow-sm space-y-10 fade-up">
                ...
                <img
                  ...
                  className="w-full max-w-xl mx-auto object-contain rounded-sm shadow-sm cursor-pointer"
                  referrerPolicy="no-referrer"
        ...
        <section className="py-24 max-w-7xl mx-auto px-6 border-b border-mist/10" id="project-inspiration-section">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 grid grid-cols-2 gap-4">
              <div
                className="aspect-[3/4] rounded-sm overflow-hidden bg-paper/40 border border-mist/10 shadow-md cursor-pointer group relative flex items-center justify-center"
